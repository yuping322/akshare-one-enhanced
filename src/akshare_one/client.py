"""Akshare One Client API

This module contains all the public API functions for accessing financial data.
These functions provide a unified interface to various data sources.
"""

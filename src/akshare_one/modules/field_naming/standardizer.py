...
class FieldStandardizer:
    ...
    def standardize_field_name(self, field_name: str, field_type: FieldType) -> str:
        """
        标准化单个字段名
    ...
    def standardize_dataframe(self, df: pd.DataFrame, field_mapping: dict[str, FieldType]) -> pd.DataFrame:
        """
        标准化整个DataFrame的字段名

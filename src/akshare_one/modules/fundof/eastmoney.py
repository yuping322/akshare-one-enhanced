...
This module implements FOF data provider using EastMoney API as the data source.
"""
...
class EastMoneyFOFProvider(FOFProvider):
    """
    FOF data provider using EastMoney API as the data source.
    ...
    def get_fof_list(self) -> pd.DataFrame:
        """
        Get FOF list from EastMoney API.

...
class SinaNorthboundProvider(NorthboundProvider):
    ...
    def get_northbound_flow(self, start_date: str, end_date: str, market: str) -> pd.DataFrame:
        ...
        return pd.DataFrame(
            columns=["date", "market", "inflow", "outflow", "net_inflow", "buy_amount", "sell_amount", "balance"]
        )
    ...
    def get_northbound_holdings(self, symbol: str | None, start_date: str, end_date: str) -> pd.DataFrame:
        ...
        self.validate_date_range(start_date, end_date)
        return pd.DataFrame(columns=["date", "symbol", "name", "shares", "比例", "change_shares", "change_ratio"])
    ...
    def get_northbound_top_stocks(self, date: str, market: str, top_n: int) -> pd.DataFrame:
        ...
        return pd.DataFrame(columns=["rank", "symbol", "name", "shares", "比例", "change_shares", "change_ratio"])

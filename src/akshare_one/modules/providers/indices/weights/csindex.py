"""
CSIndex provider for index weights data.
"""
...
@IndexWeightsFactory.register("csindex")
class CSIndexWeightsProvider(IndexWeightsProvider):
    """Index weights data provider using CSIndex API."""

...
def get_lpr_rate(
    ...
    return provider.get_lpr_rate(start_date, end_date)
...
def get_pmi_index(
    ...
    """
    provider = MacroFactory.get_provider(source=source)
    return provider.get_pmi_index(start_date, end_date, pmi_type)
...
def get_cpi_data(
    ...
    """
    provider = MacroFactory.get_provider(source=source)
    return provider.get_cpi_data(start_date, end_date)
...
def get_ppi_data(
    ...
    """
    provider = MacroFactory.get_provider(source=source)
    return provider.get_ppi_data(start_date, end_date)
...
def get_m2_supply(
    ...
    """
    provider = MacroFactory.get_provider(source=source)
    return provider.get_m2_supply(start_date, end_date)
...
def get_shibor_rate(
    ...
    """
    provider = MacroFactory.get_provider(source=source)
    return provider.get_shibor_rate(start_date, end_date)
...
def get_social_financing(
    ...
    """
    provider = MacroFactory.get_provider(source=source)
    return provider.get_social_financing(start_date, end_date)

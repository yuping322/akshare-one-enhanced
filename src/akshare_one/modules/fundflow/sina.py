...
class SinaFundFlowProvider(FundFlowProvider):
    ...
    def get_stock_fund_flow(
        ...
        return self.create_empty_dataframe([
            'date', 'symbol', 'name', 'net_inflow', 'net_inflow_rate',
            'main_inflow', 'main_inflow_rate', 'retail_inflow', 'retail_inflow_rate'
        ])
    ...
    def get_sector_fund_flow(
        ...
        return self.create_empty_dataframe([
            'date', 'sector_code', 'sector_name', 'net_inflow', 'net_inflow_rate',
            'up_count', 'down_count'
        ])
    ...
    def get_main_fund_flow_rank(
        ...
        return self.create_empty_dataframe([
            'rank', 'symbol', 'name', 'net_inflow', 'net_inflow_rate', 'price'
        ])
    ...
    def get_industry_constituents(self, industry_code: str) -> pd.DataFrame:
        ...
        return self.create_empty_dataframe([
            'symbol', 'name', 'weight', 'net_inflow', 'price_change'
        ])

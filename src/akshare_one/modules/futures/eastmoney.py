...
class EastmoneyFuturesHistoricalProvider(HistoricalFuturesDataProvider):
    ...
    def get_hist_data(self) -> pd.DataFrame:
        ...
        return pd.DataFrame(columns=[
            'timestamp', 'symbol', 'contract', 'open', 'high', 'low',
            'close', 'volume', 'open_interest', 'settlement'
        ])
...
class EastmoneyFuturesRealtimeProvider(RealtimeFuturesDataProvider):
    ...
    def get_current_data(self) -> pd.DataFrame:
        ...
        return pd.DataFrame(columns=[
            'symbol', 'contract', 'price', 'change', 'pct_change',
            'timestamp', 'volume', 'open_interest', 'open', 'high', 'low',

...
def get_industry_list(source: Optional[str] = None):
...
def get_industry_stocks(industry: str, source: Optional[str] = None) -> List[str]:
    """
...
def get_market_breadth(date: Optional[str] = None) -> float:

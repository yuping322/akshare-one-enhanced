...
SW_LEVEL1_CODES = {
    ...
    "有色金属": "801050", "电子": "801080", "家用电器": "801110", "食品饮料": "801120", 
    "纺织服装": "801130", "轻工制造": "801140", "医药生物": "801150", "公用事业": "801160", 
    "交通运输": "801170", "房地产": "801180", "商业贸易": "801190", "休闲服务": "801200", 
    "综合": "801210", "建筑材料": "801710", "建筑装饰": "801720", "电气设备": "801730", 
    "国防军工": "801740", "计算机": "801750", "传媒": "801760", "通信": "801770", 
    "银行": "801780", "非银金融": "801790", "汽车": "801880", "机械设备": "801890",
}
...
class SWIndustryProvider(IndustryProvider):
    ...
    def get_industry_list(self) -> pd.DataFrame:
        return pd.DataFrame([{"industry_code": v, "industry_name": k, "source": "sw"} for k, v in SW_LEVEL1_CODES.items()])
    ...
    def get_industry_stocks_jq(self, industry_name: str) -> List[str]:
        ...
        stocks = []
        for c in df["symbol"]:
            stocks.append(f"{str(c).zfill(6)}.XSHG" if str(c).startswith("6") else f"{str(c).zfill(6)}.XSHE")
        return stocks

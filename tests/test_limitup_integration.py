...
class TestLimitUpDownIntegration:
    ...
    def test_get_limit_down_pool_real(self):
        ...
        expected_columns = ["date", "symbol", "name", "close_price", "limit_down_time", "open_count", "turnover_rate"]
        for col in expected_columns:
            assert col in result.columns
    ...
    def test_get_limit_up_stats_real(self):
        ...
        expected_columns = ["date", "limit_up_count", "limit_down_count", "broken_rate"]
        for col in expected_columns:
            assert col in result.columns

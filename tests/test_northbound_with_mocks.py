...
class TestNorthboundFlowWithMocks:
    ...
    def test_get_northbound_flow_all_market_mocked(self, mock_northbound_flow_api):
        ...
        """
        df = get_northbound_flow(start_date="2024-01-15", end_date="2024-01-17", market="all")
        ...
        assert "northbound_net_buy" in df.columns
    ...
    def test_get_northbound_flow_data_conversion(self, mock_northbound_flow_api):
        ...
        if not df.empty:
            ...
            actual_value = df["northbound_net_buy"].iloc[0]
...
class TestNorthboundHoldingsWithMocks:
    ...
    def test_get_northbound_holdings_specific_stock_mocked(self, mock_northbound_holdings_individual_api):
        """
        Test fetching northbound holdings for a specific stock using mock data.
        """
        symbol = "600000"
        df = get_northbound_holdings(symbol=symbol, start_date="2024-01-15", end_date="2024-01-17")
    ...
    def test_get_northbound_holdings_all_stocks_mocked(self, mock_northbound_holdings_all_api):
        """
        Test fetching northbound holdings for all stocks using mock data.
        """
        df = get_northbound_holdings(symbol=None, start_date="2024-01-01", end_date="2024-01-31")
...
class TestNorthboundTopStocksWithMocks:
    ...
    def test_get_northbound_top_stocks_mocked(self, mock_northbound_top_stocks_api):
        ...
        """
        df = get_northbound_top_stocks(date="2024-01-17", market="all", top_n=10)
    ...
    def test_get_northbound_top_stocks_market_filter_sh(self, mock_northbound_top_stocks_api):
        """
        Test filtering top stocks by Shanghai market.

        Shanghai stocks should start with '6'.
        """
        df = get_northbound_top_stocks(date="2024-01-17", market="sh", top_n=5)
...
class TestNorthboundJSONCompatibility:
    ...
    def test_northbound_top_stocks_json_serializable_mocked(self, mock_northbound_top_stocks_api):
        """
...
class TestNorthboundWithCustomMock:
    ...
    def test_with_custom_mock_data(self, mock_api_response, mocker):
        ...
        df = get_northbound_flow(start_date="2024-02-01", end_date="2024-02-02", market="all")

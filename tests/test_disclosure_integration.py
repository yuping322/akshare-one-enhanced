...
class TestDisclosureNewsIntegration:
    ...
    def test_get_disclosure_news_all_categories(self):
        ...
        df = get_disclosure_news(symbol=None, start_date=start_date, end_date=end_date, category="all")
    ...
    def test_get_disclosure_news_specific_symbol(self):
        ...
        df = get_disclosure_news(symbol=symbol, start_date=start_date, end_date=end_date, category="all")
    ...
    def test_get_disclosure_news_major_event_category(self):
        ...
        df = get_disclosure_news(symbol=None, start_date=start_date, end_date=end_date, category="major_event")
        ...
        if not df.empty:
            ...
            has_keyword = any(
                any(keyword in title or keyword in category for keyword in major_keywords)
    ...
    def test_get_disclosure_news_invalid_symbol(self):
        ...
        with pytest.raises(ValueError, match="Invalid symbol format"):
            get_disclosure_news(symbol="invalid", start_date="2024-01-01", end_date="2024-01-31", category="all")

    def test_get_disclosure_news_invalid_date_range(self):
        """Test that invalid date range raises ValueError."""
        with pytest.raises(ValueError, match="start_date .* must be <= end_date"):
            get_disclosure_news(symbol=None, start_date="2024-12-31", end_date="2024-01-01", category="all")

    def test_get_disclosure_news_invalid_category(self):
        """Test that invalid category raises ValueError."""
        with pytest.raises(ValueError, match="Invalid category"):
            get_disclosure_news(symbol=None, start_date="2024-01-01", end_date="2024-01-31", category="invalid")
...
class TestDisclosureDividendIntegration:
    ...
    def test_get_dividend_data_real_api(self):
        ...
        df = get_dividend_data(symbol=symbol, start_date="2020-01-01", end_date="2024-12-31")
    ...
    def test_get_dividend_data_structure(self):
        ...
        df = get_dividend_data(symbol="600000", start_date="2024-01-01", end_date="2024-12-31")
    ...
    def test_get_dividend_data_invalid_symbol(self):
        """Test that invalid symbol raises ValueError."""
        with pytest.raises(ValueError, match="Invalid symbol format"):
            get_dividend_data(symbol="invalid", start_date="2024-01-01", end_date="2024-12-31")

    def test_get_dividend_data_invalid_date_range(self):
        """Test that invalid date range raises ValueError."""
        with pytest.raises(ValueError, match="start_date .* must be <= end_date"):
            get_dividend_data(symbol="600000", start_date="2024-12-31", end_date="2024-01-01")
...
class TestDisclosureRepurchaseIntegration:
    ...
    def test_get_repurchase_data_real_api(self):
        ...
        df = get_repurchase_data(symbol=None, start_date="2024-01-01", end_date="2024-12-31")

        # Check structure
        assert isinstance(df, pd.DataFrame)
        expected_columns = ["symbol", "announcement_date", "progress", "amount", "quantity", "price_range"]
        assert list(df.columns) == expected_columns
    ...
    def test_get_repurchase_data_structure(self):
        ...
        df = get_repurchase_data(symbol="600000", start_date="2024-01-01", end_date="2024-12-31")
    ...
    def test_get_repurchase_data_invalid_symbol(self):
        """Test that invalid symbol raises ValueError."""
        with pytest.raises(ValueError, match="Invalid symbol format"):
            get_repurchase_data(symbol="invalid", start_date="2024-01-01", end_date="2024-12-31")

    def test_get_repurchase_data_invalid_date_range(self):
        """Test that invalid date range raises ValueError."""
        with pytest.raises(ValueError, match="start_date .* must be <= end_date"):
            get_repurchase_data(symbol="600000", start_date="2024-12-31", end_date="2024-01-01")
...
class TestDisclosureSTDelistIntegration:
    ...
    def test_get_st_delist_data_real_api(self):
        ...
        # Check structure
        assert isinstance(df, pd.DataFrame)
        expected_columns = ["symbol", "name", "st_type", "risk_level", "announcement_date"]
        assert list(df.columns) == expected_columns

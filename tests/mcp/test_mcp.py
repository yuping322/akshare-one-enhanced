...
try:
    from akshare_one_mcp import mcp, run_server
...
class TestTimeInfoLogic:
    ...
    def test_time_info_structure(self):
        ...
        from akshare_one_mcp.server import get_time_info
...
class TestMCPIntegration:
    ...
    @patch("akshare_one_mcp.server.ako.get_hist_data")
    ...
    @patch("akshare_one_mcp.server.ako.get_realtime_data")

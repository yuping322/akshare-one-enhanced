...
class TestETFHistDataContract:
    ...
    def test_etf_hist_data_required_fields(self):
    ...
    def test_etf_hist_data_field_types(self):
    ...
    def test_etf_hist_data_value_ranges(self):
...
class TestIndexListContract:
    ...
    def test_index_list_required_fields(self):
        ...
        if df.empty:
            pytest.skip("No index list data available")
    ...
    def test_index_list_field_types(self):
        ...
        assert pd.api.types.is_string_dtype(df["symbol"]), "symbol must be string"
        assert pd.api.types.is_string_dtype(df["name"]), "name must be string"
...
class TestNorthboundFlowContract:
    ...
    def test_northbound_flow_field_types(self):
...
class TestFundFlowContract:
    ...
    def test_fund_flow_required_fields(self):
    ...
    def test_fund_flow_field_types(self):
...
class TestFuturesHistDataContract:
    ...
    def test_futures_hist_data_required_fields(self):
        ...
        if df.empty:
            pytest.skip("No futures historical data available")

        required_fields = ["timestamp", "symbol", "contract", "open", "high", "low", "close", "volume", "open_interest"]
        for field in required_fields:
            assert field in df.columns, f"Missing required field: {field}"
    ...
    def test_futures_hist_data_field_types(self):
        ...
        assert pd.api.types.is_numeric_dtype(df["close"]), "close must be numeric"
        assert pd.api.types.is_numeric_dtype(df["volume"]), "volume must be numeric"
        assert pd.api.types.is_numeric_dtype(df["open_interest"]), "open_interest must be numeric"
...
class TestFinancialMetricsContract:
    ...
    def test_financial_metrics_required_fields(self):
...
class TestCrossAPIConsistency:
    ...
    def test_price_unit_consistency(self):
...
class TestFieldNameStandardization:
    ...
    def test_no_chinese_field_names(self):
